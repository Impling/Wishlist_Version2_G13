    ...
    public class WishlistController : Controller
    {
        ...
        public WishlistController(WishlistContext context)
        {
            ...
            if (_context.Wishlists.Count() == 0) //Generate basic value incase context empty - For demonstration and testpurposes - a few things will be generated (easier to clear DB and refill with base values)
            {
                ...
                //Created Wislists
                _context.Wishlists.Add(new WishlistItem { Title = "Happy times", OwnerId = 1, Occasion = "Anniversery", IsOpen = false, Deadline= new DateTime(2018, 12, 16) });
                _context.Wishlists.Add(new WishlistItem { Title = "New Garden", OwnerId = 1, Occasion = "Garden renovations finished", IsOpen = true, Deadline = new DateTime(2018, 9, 2) });
                _context.Wishlists.Add(new WishlistItem { Title = "Birthday", OwnerId = 2, Occasion = "Its my birhtday", IsOpen = false, Deadline = new DateTime(2018, 11, 30) });
                _context.Wishlists.Add(new WishlistItem { Title = "Wedding", OwnerId = 2, Occasion = "Me and hubby getting married", IsOpen = true, Deadline = new DateTime(2019, 6, 3) });
